...
public class scheduler_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appDatabase = AppDatabase.getAppdatabase(scheduler_activity.this);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(scheduler_activity.this);
    ...
    public void addReminder(){
        ...
        dialog = new Dialog(scheduler_activity.this);
        ...
        select.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog dialog = new DatePickerDialog(scheduler_activity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, final int year, final int month, final int dayOfMonth) {

                        final Calendar newDate = Calendar.getInstance();
                        Calendar newTime = Calendar.getInstance();
                        TimePickerDialog time = new TimePickerDialog(scheduler_activity.this, new TimePickerDialog.OnTimeSetListener() {
                            @Override
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                if(newDate.getTimeInMillis()-tem.getTimeInMillis()>0)
                                    ...
                                    Toast.makeText(scheduler_activity.this,"Invalid time",Toast.LENGTH_SHORT).show();
        ...
        add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(scheduler_activity.this,NotifierAlarm.class);
                ...
                PendingIntent intent1 = PendingIntent.getBroadcast(scheduler_activity.this,reminders.getId(),intent,PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE);
                AlarmManager alarmManager = (AlarmManager)getSystemService(ALARM_SERVICE);
                alarmManager.setExact(AlarmManager.RTC_WAKEUP,calendar.getTimeInMillis(),intent1);

                Toast.makeText(scheduler_activity.this,"Added Successfully",Toast.LENGTH_SHORT).show();
                setItemsInRecyclerView();
