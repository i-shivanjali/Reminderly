...
public class NotifierAlarm extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Intent intent1 = new Intent(context,scheduler_activity.class);
        intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);

        TaskStackBuilder taskStackBuilder = TaskStackBuilder.create(context);
        taskStackBuilder.addParentStack(scheduler_activity.class);
        taskStackBuilder.addNextIntent(intent1);

        PendingIntent intent2 = taskStackBuilder.getPendingIntent(1,PendingIntent.FLAG_UPDATE_CURRENT | PendingIntent.FLAG_MUTABLE );
